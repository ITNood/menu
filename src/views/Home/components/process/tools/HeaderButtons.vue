<template>
  <div class="header">
    ...
    <el-dialog title="预览" width="60%" :visible.sync="previewModelVisible" append-to-body destroy-on-close>
      <highlightjs autodetect :language="previewType" :code="previewResult" style="height: 60vh"/>
    </el-dialog>
    ...
    <el-button-group key="file-control">
      ...
      <el-tooltip effect="light">
        <div slot="content">
          <el-button :size="size" type="text" @click="downloadProcessAsXml()">下载为XML文件</el-button>
          <br/>
          <el-button :size="size" type="text" @click="downloadProcessAsSvg()">下载为SVG文件</el-button>
          <br/>
          <el-button :size="size" type="text" @click="downloadProcessAsBpmn()">下载为BPMN文件</el-button>
        </div>
...
<!--      </el-tooltip>-->
    ...
    <el-button-group key="align-control">
      <el-tooltip effect="light" content="向左对齐">
        <el-button :size="size" class="align align-left" icon="el-icon-s-data"
                   @click="elementsAlign('left')"/>
      </el-tooltip>
      <el-tooltip effect="light" content="向右对齐">
        <el-button :size="size" class="align align-right" icon="el-icon-s-data"
                   @click="elementsAlign('right')"/>
      </el-tooltip>
      <el-tooltip effect="light" content="向上对齐">
        <el-button :size="size" class="align align-top" icon="el-icon-s-data"
                   @click="elementsAlign('top')"/>
      </el-tooltip>
      <el-tooltip effect="light" content="向下对齐">
        <el-button :size="size" class="align align-bottom" icon="el-icon-s-data"
                   @click="elementsAlign('bottom')"/>
      </el-tooltip>
      <el-tooltip effect="light" content="水平居中">
        <el-button :size="size" class="align align-center" icon="el-icon-s-data"
                   @click="elementsAlign('center')"/>
      </el-tooltip>
      <el-tooltip effect="light" content="垂直居中">
        <el-button :size="size" class="align align-middle" icon="el-icon-s-data"
    ...
    <el-button-group key="scale-control">
      ...
      <el-tooltip effect="light" content="自适应">
        <el-button :size="size" icon="el-icon-c-scale-to-original" @click="processAutoZoom()"/>
      </el-tooltip>
    </el-button-group>

    <el-button-group key="stack-control">
      <el-tooltip effect="light" content="撤销">
        <el-button :size="size" :disabled="!bpmn.get('commandStack').canRedo" icon="el-icon-refresh-left"
                   @click="processUndo()"/>
      </el-tooltip>
      <el-tooltip effect="light" content="恢复">
        <el-button :size="size" :disabled="!bpmn.get('commandStack').canUndo" icon="el-icon-refresh-right"
                   @click="processRedo()"/>
      </el-tooltip>
