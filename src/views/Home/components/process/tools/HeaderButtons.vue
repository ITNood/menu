<template>
  <div class="header">
    <input type="file" id="files" ref="refFile" style="display: none" @change="importLocalFile" accept=".xml, .bpmn"/>
    ...
    <el-button-group key="file-control">
      ...
      <el-tooltip effect="light">
        <div slot="content">
          <el-button :size="size"
                     type="text"
                     @click="downloadProcessAsXml()">下载为XML文件
          </el-button>
          <br/>
          <el-button :size="size"
                     type="text"
                     @click="downloadProcessAsSvg()">下载为SVG文件
          </el-button>
          <br/>
          <el-button :size="size"
                     type="text"
                     @click="downloadProcessAsBpmn()">下载为BPMN文件
          </el-button>
        </div>
        <el-button :size="size"
                   :type="type"
                   icon="el-icon-download">下载文件
        </el-button>
      </el-tooltip>
      <el-tooltip effect="light">
        <div slot="content">
          <el-button :size="size"
                     type="text"
                     @click="previewProcessXML">预览XML
          </el-button>
          <br/>
          <el-button :size="size"
                     type="text"
                     @click="previewProcessJson">预览JSON
          </el-button>
        </div>
        <el-button :size="size"
                   :type="type"
...
export default {
  ...
  methods: {
    ...
    importLocalFile() {
      const that = this;
      const file = that.$refs.refFile.files[0];
